        ...
        <div className='container mx-auto px-4 py-20 relative'>
          <div className='text-center max-w-3xl mx-auto space-y-6'>
            ...
            <p className='text-xl text-muted-foreground max-w-2xl mx-auto'>
              Explore {instruments.length}+ instruments from around the world.
              Complete API with detailed information about each instrument.
            </p>
          ...
          <>
            <div className='text-center mb-6'>
              <p className='text-sm text-muted-foreground'>
                Showing {filteredInstruments.length} instrument
            ...
            <div className='grid md:grid-cols-2 gap-4 text-sm'>
              <div className='p-4 rounded-lg bg-muted/50 border border-border/50'>
                <code className='text-primary font-mono'>
                  GET {SUPABASE_URL}/functions/v1/instruments-api
                </code>
              ...
              <div className='p-4 rounded-lg bg-muted/50 border border-border/50'>
                <code className='text-primary font-mono'>
                  GET {SUPABASE_URL}/functions/v1/instruments-api/:id
                </code>
                <p className='text-muted-foreground mt-2'>
              ...
              <div className='p-4 rounded-lg bg-muted/50 border border-border/50'>
                <code className='text-primary font-mono'>
                  GET {SUPABASE_URL}/functions/v1/instruments-api/categories
                </code>
                <p className='text-muted-foreground mt-2'>
              ...
              <div className='p-4 rounded-lg bg-muted/50 border border-border/50'>
                <code className='text-primary font-mono'>
                  GET {SUPABASE_URL}/functions/v1/instruments-api/stats
                </code>
                <p className='text-muted-foreground mt-2'>
